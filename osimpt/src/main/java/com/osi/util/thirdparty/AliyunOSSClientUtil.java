package com.osi.util.thirdparty;
...
import com.osi.util.safe.OSSClientConstants;
...
public class AliyunOSSClientUtil {
     ...
     * */
    public static Map uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String folder) {
        Map map = new HashMap();
...
//        return resultStr;
     ...
     * 直接上传文件
     * @param file 文件
     * @return Map<String,Object> 文件MD5Key和文件Key
     */
    public static Map<String,Object> updOSSObject(File file){
        OSSClient ossClient = getOSSClient();
        return uploadObject2OSS(ossClient,file,BACKET_NAME,FOLDER);
    }
    /**
     * 上传文件流
     * @param inputStream 文件流 fileName 文件名/key
     * @return String MD5Key
     */
    ...
    public static void main(String[] args) {
        ...
        //上传文件
        String files="D:\\image\\1010.jpg,D:\\image\\1111.jpg";
